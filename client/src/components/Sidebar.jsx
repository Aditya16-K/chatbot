  ...
  return (
    <>
      ...
      >
        ...
        {/* Search Conversation */}
        <div className="flex items-center gap-2 p-3 mt-4 border border-gray-400 dark:boarder-white/20 rounded-md">
          <img
        ...
        {/* user Account */}
        <div className="flex items-center gap-4 p-3 mt-4 border border-gray-300 dark:border-white/15 rounded-md cursor-pointer group ">
