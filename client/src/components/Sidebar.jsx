...
const Sidebar = ({ isMenuOpen, setIsMenuOpen }) => {
  ...
  return (
    <div
      className={`flex flex-col h-screen min-w-72 p-5 dark:bg-gradient-to-b from-[#242124]/30 to-[#000000]/30 border-r border-[#80609F]/30 backdrop-blur-3xl transition-all duration-500 max-md:absolute left-0 z-50 ${
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 p-3 mt-4 border border-gray-300 dark:border-white/15 rounded-md">
        ...
        <label className="relative inline-flex cursor-pointer">
          ...
          />
          <div className="w-9 h-5 bg-gray-400 rounded-full peer-checked:bg-purple-600 transition"></div>
      ...
      <div
        className="flex items-center gap-4 p-3 mt-4 border border-gray-300 dark:border-white/15 rounded-md cursor-pointer group relative"
        onClick={() => setShowLogout((prev) => !prev)} // toggle logout on click
        onMouseLeave={() => setShowLogout(false)} // hide on desktop mouse leave
      >
        ...
        {user && (
          <img
            ...
            alt="Logout"
            className={`h-5 w-5 cursor-pointer absolute right-3 top-3 transition-all
